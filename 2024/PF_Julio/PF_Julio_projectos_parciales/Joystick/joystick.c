...
#define JOY_DOWN_SPULSE_FILTER(x)    ARE_ALL_BITS_SET((x), SHORT_PULSE_MASK)
#define JOY_LEFT_SPULSE_FILTER(x)    ARE_ALL_BITS_SET((x), (SHORT_PULSE_MASK << 6))
#define JOY_CENTER_SPULSE_FILTER(x)  ARE_ALL_BITS_SET((x), (SHORT_PULSE_MASK << 12))
#define JOY_UP_SPULSE_FILTER(x)      ARE_ALL_BITS_SET((x), (SHORT_PULSE_MASK << 18))
#define JOY_RIGHT_SPULSE_FILTER(x)   ARE_ALL_BITS_SET((x), (SHORT_PULSE_MASK << 24))
